...
#[tonic::async_trait]
impl<S: ProvableStore> ClientQuery for IbcClientService<S> {
...
#[tonic::async_trait]
impl<S: ProvableStore> ConnectionQuery for IbcConnectionService<S> {
    async fn connection(
        &self,
...
#[tonic::async_trait]
impl<S: ProvableStore> ChannelQuery for IbcChannelService<S> {
    async fn channel(
        &self,
