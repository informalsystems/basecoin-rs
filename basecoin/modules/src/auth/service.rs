...
use ibc_proto::cosmos::auth::v1beta1::query_server::Query;
...
use crate::auth::account::RELAYER_ACCOUNT;
use crate::auth::context::AccountReader;
...
#[tonic::async_trait]
impl<S: ProvableStore> Query for AuthService<S> {
    async fn accounts(
        &self,
