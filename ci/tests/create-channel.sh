...
"${HERMES_BIN}" create connection --a-chain ibc-0 --a-client 07-tendermint-1 --b-client 07-tendermint-0
...
"${HERMES_BIN}" create connection --a-chain basecoin-0 --a-client 07-tendermint-0 --b-client 07-tendermint-1
